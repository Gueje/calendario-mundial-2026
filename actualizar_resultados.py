...
bracket.json y grupos.json. Ejecutado por GitHub Actions cada hora.
"""
...
# Construido y verificado via diagnostico en multiples sesiones
ID_TO_KEY = {
    ...
    # ── RONDA DE 32 — IDs confirmados 28 jun 2026 ─────────────────
    ...
    # ── OCTAVOS DE FINAL — IDs confirmados 4 jul 2026 ─────────────
    ...
    # ── CUARTOS DE FINAL — IDs confirmados 14 jul 2026 ────────────
    537383: "Francia vs Marruecos",       # M97
    537384: "España vs Bélgica",          # M98
    537385: "Noruega vs Inglaterra",      # M99
    537386: "Argentina vs Suiza",         # M100
    # ── SEMIFINALES — IDs confirmados 14 jul 2026 ─────────────────
    537387: "Francia vs España",          # M101
    537388: "Inglaterra vs Argentina",    # M102
    # ── FINAL y 3er PUESTO — IDs conocidos, equipos TBD ──────────
    # 537389: tercer lugar (equipos TBD hasta semis)
    # 537390: final (equipos TBD hasta semis)
    # Se resuelven dinámicamente via actualizar_bracket()
}

# IDs donde el orden local/visitante de la API es el INVERSO del HTML
IDS_INVERTIDOS = {
    # (vacío por ahora)
}
...
def fetch_standings():
    ...
    try:
        ...
        print(f"AVISO: no se pudo obtener standings ({e}). Se omite grupos.json.")
        return None
...
def actualizar_bracket(results):
    ...
    try:
        ...
        print("AVISO: no existe bracket.json en el repo, se omite.")
        return
    except Exception as e:
...
def main():
    ...
    for match in data.get("matches", []):
        ...
        # football-data.org incluye penales dentro de fullTime.
        # Cuando hay tanda, restamos para obtener el marcador real.
    ...
    try:
        ...
        print(f"AVISO: error actualizando bracket.json ({e}).")
    ...
    try:
        ...
        print(f"AVISO: error generando grupos.json ({e}).")
